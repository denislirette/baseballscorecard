...
[Denis Lirette](https://github.com/denislirette) is a designer with interests in data visualization, AI tooling, and baseball scorekeeping. He built this project by combining his design skills with Claude Code (Anthropic's AI) for back-end development, environment setup, and project organization. The collaboration started in March 2026.

Read the full [Origin Story](origin-story.md) for more on how design and AI came together to build this.
