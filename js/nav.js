...
function initFooter() {
  ...
  footer.innerHTML = `
    <div class="footer-content">
      ...
      <div class="footer-disclaimer">This system isn't perfect and has bugs. Double check stats<br>before committing pen to paper and have some white-out nearby.</div>
    </div>`;
